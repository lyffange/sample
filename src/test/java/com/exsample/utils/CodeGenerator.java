...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        String moduleName = "exsample";//用来拼接包名，当前模块名
        // 1、创建代码生成器
        ...
        pc.setParent("com.exsample.codegenerator");
        ...
        //设置BaseEntity
//        strategy.setSuperEntityClass("com.exsample.codegenerator.base.model.BaseEntity");
        // 填写BaseEntity中的公共字段
